...
public class SongLikeRestController {
    ...
    public ResponseEntity<Long> addSongLike(@RequestBody SongLikeDto dto, Authentication authentication) {
        ...
        long likesCount = songSvc.countSongLikes(dto.getSongId());  // 해당 노래의 좋아요 수를 계산합니다.
    ...
    public ResponseEntity<Long> deleteSongLike(@PathVariable long songId, Authentication authentication) {
        ...
        long likesCount = songSvc.countSongLikes(songId);  // 좋아요 취소 후의 좋아요 수를 계산합니다.
        return ResponseEntity.ok(likesCount);
    }
