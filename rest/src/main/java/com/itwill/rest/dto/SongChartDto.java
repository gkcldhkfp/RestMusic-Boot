...
public class SongChartDto {
	private Long songId; // 음악 번호
    private Long albumId; // 앨범 번호
    private String albumImage; // 앨범 표지
    private String title; // 노래 제목
    private List<Long> artistIds; // 아티스트 번호 리스트
