...
//	@Test
	...
	public void saveBol4Album() {
		...
		Album album = Album
				.builder()
				.albumName("RED PLANET")
				.albumImage("bol4_RED PLANET_albumcover.png")
				.albumReleaseDate(LocalDate.of(2016, 8, 29))
				.albumType("정규")
				.build();
		album = albumRepo.save(album);
		log.info("album = {}", album);
		...
		Song song1 = Song.builder()
				.album(album)
				.title("우주를 줄게")
				.songPath("BOL4 - Galaxy(우주를 줄게).mp3")
				.lyrics("bol4우주를 줄게.txt")
				.build();
		...
		Song song3 = Song.builder()
				.album(album)
				.title("You(=I)")
				.songPath("BOL4 - You(=I).mp3")
				.lyrics("bol4You(=I).txt")
				.build();
		...
		Song song5 = Song.builder()
				.album(album)
				.title("나만 안되는 연애")
				.songPath("BOL4 - 나만 안되는 연애.mp3")
				.lyrics("bol4나만 안되는 연애.txt")
				.build();
		...
		Song song6 = Song.builder()
				.album(album)
				.title("초콜릿")
				.songPath("BOL4 - Chocolate Drive(초콜릿).mp3")
				.lyrics("bol4초콜릿.txt")
				.build();
		...
		Song song8 = Song.builder()
				.album(album)
				.title("X Song")
				.songPath("BOL4 - X Song.mp3")
				.lyrics("bol4X Song.txt")
				.build();
		...
		Song song10 = Song.builder()
				.album(album)
				.title("사랑에 빠졌을 때")
				.songPath("BOL4 - 사랑에 빠졌을 때.mp3")
				.lyrics("bol4사랑에 빠졌을 때.txt")
				.build();
		...
		TitleSong titleSong1 = TitleSong.builder()
				.id(titleSongId1)
				.album(album)
				.song(song1)
				.build();
		...
		TitleSong titleSong2 = TitleSong.builder()
				.id(titleSongId2)
				.album(album)
				.song(song5)
				.build();
		...
		songs.forEach(s -> {
			SongGenre 인디등록 = SongGenre.builder()
					.genreCode(인디)
					.song(s)
					.id(new SongGenreId(s.getSongId(), 인디.getCodeId()))
					.build();
			genres.add(인디등록);

			SongGenre 포크등록 = SongGenre.builder()
					.genreCode(포크블루스)
					.song(s)
					.id(new SongGenreId(s.getSongId(), 포크블루스.getCodeId()))
					.build();
			genres.add(포크등록);
		});
		...
		// 그룹 객체 생성
		Group bol4 = Group.builder()
				.groupName("볼빨간 사춘기")
				.groupDescription("볼빨간 사춘기 멤버 = 안지영, 우지윤(탈퇴)")
				.build();

		groupRepo.save(bol4);

		// 아티스트 객체 생성
		Artist ahn = Artist.builder()
				.artistName("안지영")
				.artistImage("볼빨간사춘기아티스트사진.png")
				.artistDescription("bol4_설명.txt")
				.build();

		// DB에 삽입
		artistRepo.save(ahn);

		Artist woo = Artist.builder()
				.artistName("우지윤")
				.artistImage("볼빨간사춘기아티스트사진.png")
				.artistDescription("bol4_설명.txt")
				.build();
		...
		GroupMember member1 = GroupMember.builder()
				.group(bol4)
				.artist(ahn)
				.id(new GroupMemberId(bol4.getId(), ahn.getId()))
				.build();
		...
		GroupMember member2 = GroupMember.builder()
				.group(bol4)
				.artist(woo)
				.id(new GroupMemberId(bol4.getId(), woo.getId()))
				.build();
		...
		ArtistRole song1Role2 = ArtistRole.builder()
				.song(song1)
				.roleCode(가수)
				.group(bol4)
				.artist(woo)
		...
		ArtistRole song1Role3 = ArtistRole.builder()
				.song(song1)
				.roleCode(작사)
				.group(bol4)
				.artist(ahn)
		...
		ArtistRole song1Role4 = ArtistRole.builder()
				.song(song1)
				.roleCode(작사)
				.group(bol4)
				.artist(woo)
		...
		ArtistRole song1Role5 = ArtistRole.builder()
				.song(song1)
				.roleCode(작곡)
				.group(bol4)
				.artist(ahn)
		...
		ArtistRole song1Role6 = ArtistRole.builder()
				.song(song1)
				.roleCode(작곡)
				.group(bol4)
				.artist(ahn)
		...
		ArtistRole song1Role7 = ArtistRole.builder()
				.song(song1)
				.roleCode(작곡)
				.artist(van)
		...
		ArtistRole song1Role8 = ArtistRole.builder()
				.song(song1)
				.roleCode(편곡)
				.artist(van)
		...
		ArtistRole song2Role1 = ArtistRole.builder()
				.song(song2)
				.roleCode(가수)
				.group(bol4)
				.artist(ahn)
		...
		ArtistRole song2Role2 = ArtistRole.builder()
				.song(song2)
				.roleCode(가수)
				.group(bol4)
				.artist(woo)
		...
		ArtistRole song2Role3 = ArtistRole.builder()
				.song(song2)
				.roleCode(작사)
				.group(bol4)
				.artist(ahn)
		...
		ArtistRole song2Role4 = ArtistRole.builder()
				.song(song2)
				.roleCode(작곡)
				.group(bol4)
				.artist(ahn)
		...
		ArtistRole song2Role5 = ArtistRole.builder()
				.song(song2)
				.roleCode(편곡)
				.artist(van)
		...
		ArtistRole song3Role1 = ArtistRole.builder()
				.song(song3)
				.roleCode(가수)
				.group(bol4)
				.artist(ahn)
		...
		ArtistRole song3Role2 = ArtistRole.builder()
				.song(song3)
				.roleCode(가수)
				.group(bol4)
				.artist(woo)
		...
		ArtistRole song3Role3 = ArtistRole.builder()
				.song(song3)
				.roleCode(작사)
				.group(bol4)
				.artist(ahn)
		...
		ArtistRole song3Role4 = ArtistRole.builder()
				.song(song3)
				.roleCode(작곡)
				.group(bol4)
				.artist(ahn)
		...
		ArtistRole song3Role5 = ArtistRole.builder()
				.song(song3)
				.roleCode(편곡)
				.artist(van)
